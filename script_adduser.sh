...
# Variables
USERNAMES=(
  "AKARID" "ALAOUI-KASMI" "AMSAADI" "AQESRI" "BENNANI"
  "BOUCHTI" "BOULAMTAT" "CHAHBY" "CHEBLAOUI" "EL ALAOUI"
  "EL FATHI" "EL HABCHI" "EL HIANI" "EL-ABBOUDY" "EL WADOUDI"
  ...
  "SADANI" "SARSAR" "SAYAH" "TAHIRI ALAOUI" "TALIBI"
